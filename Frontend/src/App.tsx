        ...
        <Routes>
          ...
          <Route element={<ProtectedLayout />}>
            ...
            <Route
              path="/repositories"
              element={
                <RequirePermission permission="REPOSITORIES">
                  <Repositories />
                </RequirePermission>
              }
            />
            <Route
              path="/scans"
              element={
                <RequirePermission permission="SCANS">
                  <Scans />
                </RequirePermission>
              }
            />
            <Route
              ...
              element={
                <RequirePermission permission="VULNERABILITIES">
                  <Vulnerabilities />
                </RequirePermission>
              }
            />
            ...
            <Route
              path="/profile"
              element={
                <RequirePermission permission="PROFILE">
                  <Profile />
                </RequirePermission>
              }
            />
